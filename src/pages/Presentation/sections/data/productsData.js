  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Highly flowing cementitious self-levelling agent for interiors applicable with thicknesses between 1-30 mm in adhesion to the substrate. With low shrinkage, it can also be applied to low-thickness radiant floor systems.",
      ...
      },
      {
        ...
        name: "weberfloor AL",
        description:
          "Smooth-finish cementitious self-levelling compound for leveling indoor and outdoor floors in thicknesses from 1 to 10 mm.",
        image: weberfloorAL,
      },
      {
        id: 8,
        ...
        description:
          "Self-levelling fluid screed based on anhydrite with high purity and almost zero shrinkage, for indoor applications in residential and light commercial areas, including large surfaces. Specific for application on the latest generation of low-thickness underfloor radiant systems either anchored to the substrate or with an insulating panel, it allows even distribution of heat on the surface.",
